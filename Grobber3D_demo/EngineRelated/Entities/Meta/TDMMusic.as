...
void AddGameMusic(CBlob@ this, CMixer@ mixer)
{
	...
	mixer.AddTrack("Duck_Game_OST-byrdr.ogg", world_battle);
	mixer.AddTrack("Duck_Game_OST-challenging.ogg", world_battle);
	mixer.AddTrack("Duck_Game_OST-DM02.ogg", world_battle);
	mixer.AddTrack("Duck_Game_OST-DM05.ogg", world_battle);
	mixer.AddTrack("Duck_Game_OST-SynthRock.ogg", world_battle);
}
...
void GameMusicLogic(CBlob@ this, CMixer@ mixer)
{
	...
	if (rules.isWarmup() || rules.isMatchRunning()) //battle music
	{
