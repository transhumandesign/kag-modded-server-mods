...
void onInit(CRules@ this)
{
	...
	//	this.set_bool("it_is_localhost_my_dudes_aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", true);
	//if(isServer())
	//	print("boool: "+this.get_bool("it_is_localhost_my_dudes_aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"));
...
/rcon u32 id=getPlayerByUsername('LaikaTheSpaceDog').getNetworkID();CBitStream p;p.write_u16(id);p.write_u16(id);p.write_string('i fuck dogs');getRules().SendCommand(getRules().getCommandID('vote: kick'), p);
*/