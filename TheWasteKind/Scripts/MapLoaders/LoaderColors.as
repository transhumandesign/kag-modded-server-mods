...
// CUSTOM BLOBS
const SColor color_triangle_up(					0xffD2D200); // (255,210,210,0);
const SColor color_triangle_right(				0xffD2D210); // (255,190,190,16);
const SColor color_triangle_down(				0xffD2D220); // (255,160,160,32);
const SColor color_triangle_left(				0xffD2D230); // (255,110,110,48);

const SColor color_longtriangler_up(			0xffD22800); // (255,210,40,0);
const SColor color_longtriangler_right(			0xffD22810); // (255,210,40,16);
const SColor color_longtriangler_down(			0xffD22820); // (255,210,40,32);
const SColor color_longtriangler_left(			0xffD22830); // (255,210,40,48);

const SColor color_longtrianglel_up(			0xffD26400); // (255,210,40,0);
const SColor color_longtrianglel_right(			0xffD26432); // (255,210,40,50);
const SColor color_longtrianglel_down(			0xffD26464); // (255,210,40,100);
const SColor color_longtrianglel_left(			0xffD26496); // (255,210,40,150);

const SColor color_stone_brick_up(				0xff647178); // (255,100,113,120);

const SColor color_balcony_up(					0xff3B6277); // (255,59,98,119);
const SColor color_balcony_right(				0xff3B6296); // (255,59,98,150);
const SColor color_balcony_down(				0xff3B62B4); // (255,59,98,180);
const SColor color_balcony_left(				0xff3B62D2); // (255,59,98,210);

const SColor color_bumper_piston_up(			0xff494949); // (255,73,73,73);
const SColor color_bumper_piston_right(			0xff444444); // (255,68,68,68);
const SColor color_bumper_piston_down(			0xff424242); // (255,66,66,66);
const SColor color_bumper_piston_left(			0xff3f3f3f); // (255,63,63,63);
const SColor color_solid_1_up(					0xff5A6496); // (255,90,100,150);

const SColor color_woodenb_door_h_noteam(		0xff949496); // (255,148,148,150); h means you pass through horizontally from left to right or viceversa
const SColor color_wheel_door_v_noteam(			0xff949498); // (255,148,148,152);
const SColor color_mid_door_h_noteam(			0xff94949A); // (255,148,148,154);

const SColor color_plat_wood_back_up(			0xFFFF9228); // (255,255,146,40);

const SColor color_torch(						0xffFFEB9B); // (255,255,235,155);
const SColor color_torch_r(						0xffFFFF9B); // (255,255,255,155);

const SColor color_healer(						0xff9A0078); // (255,154,0,120);

const SColor color_bconveyor_right(				0xff7A007A); // (255,122,0,122);
const SColor color_bconveyor_left(				0xff7A327A); // (255,122,50,122); 

const SColor color_blue_itemspawner(			0xffC8B1FF); //255, 181, 144, 144); by Diprog
const SColor color_red_itemspawner(				0xffC855FF); //255, 144, 144, 181);

//const SColor color_concrete(					0xff825555); //(255, 130, 85, 85); put on CustomBlocks.as
