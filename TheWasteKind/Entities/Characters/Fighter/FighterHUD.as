...
const string iconsFilename = "Entities/Characters/Fighter/FighterIcons.png";
...
void ManageCursors(CBlob@ this)
{
	...
	{
		// set cursor
		getHUD().SetCursorImage("Entities/Characters/Fighter/FighterCursor.png", Vec2f(32, 32));
