// Swing Door logic - custom sounds and old vertical horizontal behaviour
// for TWK
...
bool canOpenDoor( CBlob@ this, CBlob@ blob )
{
    if ((blob.getShape().getConsts().collidable) && //solid				 // vvv lets see
        (blob.getRadius() > 5.0f) && //large                                         // It'd be cool to open doors with thrown items
		(this.getTeamNum() == 255 || this.getTeamNum() == blob.getTeamNum() ) &&     // like grenades or throwing knives at above a given xy speed
