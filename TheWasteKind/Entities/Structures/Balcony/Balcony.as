...
all these triangles and static solids are based on the Sandboxes triangle,
which apparently is based on the trapblock.
todo: check for another example blob block -8x
*/
#include "Hitters.as"
#include "MapFlags.as"
