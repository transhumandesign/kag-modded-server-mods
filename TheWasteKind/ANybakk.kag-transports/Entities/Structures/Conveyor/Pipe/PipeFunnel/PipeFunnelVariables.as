...
namespace ANybakk {
  ...
  namespace ConveyorVariables {
    ...
    //Define up connection for down orientation (not connected through funnel end)
    ...
    //Define right connection for left orientation (not connected through funnel end)
    ...
    //Define down connection for up orientation (not connected through funnel end)
    ...
    //Define left connection for right orientation (not connected through funnel end)
