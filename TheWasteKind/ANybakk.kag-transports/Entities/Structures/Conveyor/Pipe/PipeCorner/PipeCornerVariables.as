...
namespace ANybakk {
  ...
  namespace ConveyorVariables {
    ...
    //Define up connection for left and up orientations
    ...
    //Define right connection for up and right orientations
    ...
    //Define down connection for right and down orientations
    ...
    //Define left connection for down and left orientations
