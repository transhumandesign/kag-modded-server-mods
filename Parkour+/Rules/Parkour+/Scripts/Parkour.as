...
void Config(ChallengeCore@ this)
{
	...
	s32 warmUpTimeSeconds = cfg.read_s32("warmup_time", 6);
	...
	this.start_class = cfg.read_string("start_class", "archer");
...
shared class ChallengeSpawns : RespawnSystem
{
	...
	void DoSpawnPlayer(PlayerInfo@ p_info)
	{
		...
		if (canSpawnPlayer(p_info) || first)
		{			
			p_info.team = 0;
	...
	Vec2f getSpawnLocation(int team)
	{
		...
		Vec2f respawnPos;
		if (map.getMarker("blue main spawn", respawnPos))
		{
			return respawnPos;
		}
...
shared class ChallengeCore : RulesCore
{
	...
	void AddPlayer(CPlayer@ player, u8 team = 0, string default_config = "")
	{
		...
		WarPlayerInfo p(player.getUsername(), 0, getStartClass("archer"));	// always team 0
		players.push_back(p);
