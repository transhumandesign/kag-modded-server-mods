...
{
    Splash(this, this.getPosition(), splash_halfwidth, splash_halfheight,
        splash_offset, shouldStun, true);

}

void Splash(CBlob@ this, Vec2f mpos, const uint splash_halfwidth, const uint splash_halfheight,
            const f32 splash_offset, const bool shouldStun = true, bool team = true)
{
	//extinguish fire
	...
	if (map !is null)
	{
		...
		if (is_server)
		{
			...
			for (uint i = 0; i < blobs.length; i++)
			{
				...
				bool hitHard = blob.getTeamNum() != this.getTeamNum() || !team || ownerBlob is blob;
