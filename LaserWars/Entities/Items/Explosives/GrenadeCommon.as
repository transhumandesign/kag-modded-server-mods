...
{
	this.set_string("custom_explosion_sprite", "Entities/Effects/Sprites/" + (this.getTeamNum() == 0 ? "ExplosionBlue.png" :
		                                                                      this.getTeamNum() == 1 ? "ExplosionRed.png" :
		                                                                                               "Explosion.png"));
	...
	this.AddScript("GrenadeTimer.as");
}
