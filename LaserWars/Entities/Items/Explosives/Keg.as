...
void onInit(CBlob@ this)
{
	...
	CSpriteLayer@ fuse = this.getSprite().addSpriteLayer("fuse", "Keg.png", 16, 16);
...
{
	/*if (getNet().isServer() &&
	        !isExplosionHitter(customData) && !isCustomExplosionHitter(customData) &&
