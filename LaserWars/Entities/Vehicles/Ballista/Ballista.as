...
void GetButtonsFor(CBlob@ this, CBlob@ caller)
{
	if (caller.getTeamNum() == this.getTeamNum() && isOverlapping(this, caller) && !caller.isAttached())
	{
		if (!isAnotherRespawnClose(this) && !isFlipped(this))
		{
		    ...
		    caller.CreateGenericButton(11, Vec2f(0.0f, -4.0f), this, this.getCommandID(cmd_loadout), "Loadout", params);
		}
...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params)
{
	...
	else if (cmd == this.getCommandID(cmd_loadout))
	{
		u16 id;
