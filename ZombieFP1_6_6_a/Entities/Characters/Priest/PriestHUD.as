...
void ManageCursors( CBlob@ this )
{
	...
	{
		// set cursor
		getHUD().SetCursorImage("Entities/Characters/Priest/PriestCursor.png", Vec2f(32,32));
...
void onRender( CSprite@ this )
{
	...
	if (diff > 0)
	{
		...
		GUI::DrawIcon( "prSpellIcons.png", 0, Vec2f(16,16), Vec2f(11,106));
	...
	{
		GUI::DrawIcon( "prSpellIcons.png", 2, Vec2f(16,16), Vec2f(10,58), 1.0f, 1);
	...
	// class weapon icon
	GUI::DrawIcon( iconsFilename, 3, Vec2f(16, 16), Vec2f(10, 10), 1.0f);
}
