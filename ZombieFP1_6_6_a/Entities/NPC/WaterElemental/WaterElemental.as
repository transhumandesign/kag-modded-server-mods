...
void onInit(CBlob@ this)
{
	...
	this.set_u8("attack hitter", Hitters::water);
	this.set_string("attack sound", "SplashSlow");
...
void onTick(CBlob@ this)
{
	...
	{
		this.getSprite().PlaySound("WaterBubble2");
	}
...
f32 onHit( CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitterBlob, u8 customData )
{
	if (damage >= 0.0f)
	{
	    this.getSprite().PlaySound("WaterBubble1");
    }
