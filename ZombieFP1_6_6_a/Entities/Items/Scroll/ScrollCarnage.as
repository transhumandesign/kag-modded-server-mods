...
void GetButtonsFor( CBlob@ this, CBlob@ caller )
{
	...
	caller.CreateGenericButton( 11, Vec2f_zero, this, this.getCommandID("sudden gib"), "Use this to make all visible zombies instantly turn into a pile of gibs.", params );
		...
		if (caller !is null)
		{
			...
			if (this.getMap().getBlobsInRadius( this.getPosition(), 500.0f, @blobsInRadius )) 
			{
				for (uint i = 0; i < blobsInRadius.length; i++)
				{
					...
					if (b.getTeamNum() != team && b.hasTag("flesh") && !b.hasTag("player"))
					{
