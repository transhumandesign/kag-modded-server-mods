...
void InitLoot( CBlob@ this )
{
    ...
    */
	...
	addLoot(this, "mat_waterarrows", 1, 10);
	addLoot(this, "skeleton", 2, 1);
	//addLoot(this, "sdragoon", 2, 1);
	addLoot(this, "sgargoyle", 2, 1);
	addLoot(this, "smeteor", 3, 1);
	addLoot(this, "sgreg", 4, 1);
    addLoot(this, "catto", 5, 1); //chest will drop coins with quantity 1 - 60
